...
$types = $db->in_array("SELECT * FROM types ORDER BY id ASC LIMIT $page_start, $page_count");

include "system/head.php";

$breadcump_title_1 = "Turlar";
$breadcump_title_2 = "Turlar ro'yxati";
?>
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/editType/?id=<?=$type["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="/editType/?id=<?=$type["id"]?>&type=deletetype">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
