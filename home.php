                        ...
                        <div class="card">
                            ...
                            <div class="card-body loadmore-content height620 dlab-scroll  pb-0" id="RecentActivitiesContent">
                                <div class="border-bottom pb-4 mb-4">
                                    ...
                                    <div class="row justify-content-between">
                                        <ul class="users col-6">
                                            <li><img src="theme/vora/images/users/1.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/2.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/3.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/4.jpg" alt=""></li>
                                        </ul>
                                ...
                                <div class="border-bottom pb-4 mb-4">
                                    ...
                                    <div class="row justify-content-between">
                                        <ul class="users col-6">
                                            <li><img src="theme/vora/images/users/5.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/6.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/7.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/8.jpg" alt=""></li>
                                        </ul>
                                        <div class="col-6 ps-0">
                                            <h6 class="fs-14">Progress
                                ...
                                <div class="border-bottom pb-4 mb-4">
                                    ...
                                    <div class="row justify-content-between">
                                        <ul class="users col-6">
                                            <li><img src="theme/vora/images/users/9.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/10.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/11.jpg" alt=""></li>
                                            <li><img src="theme/vora/images/users/12.jpg" alt=""></li>
                                        </ul>
                                        <div class="col-6 ps-0">
                                            <h6 class="fs-14">Progress
                        ...
                        <div class="card">
                            ...
                            <div class="card-body height620 dlab-scroll" id="upcomingprojects">
                                <div class="border-bottom pb-4 mb-4">
                                    ...
                                    <div class="d-flex">
                                        <p class="font-w600 me-auto mb-2"><a href="post-details.html" class="text-black">Redesign Kripton Mobile App</a></p>
                                ...
                                <div class="border-bottom pb-4 mb-4">
                                    <span class="fs-14 text-primary mb-2 d-block font-w500">Yoast Esac</span>
                                    <div class="d-flex">
                                        <p class="font-w600 me-auto mb-2"><a href="post-details.html" class="text-black">Build Branding Persona for Etza.id</a></p>
                                        <div class="dropdown mb-3">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div class="pb-4">
                                    <span class="fs-14 text-primary mb-2 d-block font-w500">Yoast Esac</span>
                                    <div class="d-flex">
                                        <p class="font-w600 me-auto mb-2"><a href="post-details.html" class="text-black">Manage SEO for Eclan Company Profile</a></p>
                                        <div class="dropdown mb-3">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <div class="card-body">
                                <div class="media mb-4">
                                    <div class="image-bx me-sm-4 me-2">
                                        <img src="theme/vora/images/users/1.png" alt="" class="rounded-circle img-1">
                                ...
                                <div class="media mb-4">
                                    <div class="image-bx me-sm-4 me-2">
                                        <img src="theme/vora/images/users/2.png" alt="" class="rounded-circle img-1">
                                        <span class="active"></span>
                                    </div>
                                    <div class="media-body d-sm-flex justify-content-between d-block align-items-center">
                                        <div class="me-sm-3 me-0">
                                ...
                                <div class="media">
                                    <div class="image-bx me-sm-4 me-2">
                                        <img src="theme/vora/images/users/3.png" alt="" class="rounded-circle img-1">
                                    </div>
                                    <div class="media-body d-sm-flex justify-content-between d-block align-items-center">
                                        <div class="me-sm-3 me-0">
