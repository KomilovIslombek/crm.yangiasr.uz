...
$breadcump_title_2 = "Talabalar to'lovlari statisikasi";
?>
                            ...
                            <div class="basic-form row d-flex align-items-center">
                                ...
                                <div class="row">
                                    ...
                                    foreach ($years as $year) {
                                        ...
                                        foreach ($coursesArr as $course_id => $value) {
                                            $link = "/studentsDebtorsList/?year_id=$year&payment_course_id=$course_id";
                                            echo '<a href="'.$link.'">'.$year. ' - '. ($year + 1).' ('.$value.') hisoboti</a>';
                                            echo "<br>";
                                        }
                                        echo "<hr>";
                                        echo '</div>';
                            ...
                            <table class="table table-responsive-md mb-0 table-bordered" id="table">
                                ...
                                <tbody id="customers">
                                    ...
                                    <? foreach ($students as $student) {
                                        ...
                                        if ($_GET["export"] == "excel") {
                                            $group = $all_groups[$student["group_id"]];
                                        }
                                        ?>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <? if ($_GET["export"] == "excel") { ?>
                                                ...
                                                <td>
                                                    <?=($group["name"] ? $group["name"] : "biriktirilmagan")?>
                                                </td>
                                            <? } ?>
                                        </tr>
                                        <?
