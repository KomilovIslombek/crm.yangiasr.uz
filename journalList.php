...
$tTest = $db->assoc("SELECT * FROM types WHERE id = ?", [ $_GET["type_id"] ]);
$noDateSub2 = $db4->assoc("SELECT * FROM course_sections WHERE course = ? AND name LIKE ? AND isnull(date) OR course = ? AND name LIKE ? AND isnull(date) OR date = ?", [ $_REQUEST["subject_id"], "%$tTest[name]%", $_REQUEST["subject_id"], str_replace("'", '', "%$tTest[name]%"), '0000-00-00' ]);
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Mavzularga sanasini kiriting</h5>
