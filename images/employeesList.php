...
// $employees = $db->in_array("SELECT * FROM employees WHERE role = 'employee' ORDER BY id ASC LIMIT $page_start, $page_count");
    $employees = $db->in_array("SELECT * FROM users  ORDER BY id ASC LIMIT $page_start, $page_count");
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM users")["COUNT(*)"];
                        // $count = (int)$db->assoc("SELECT COUNT(*) FROM users WHERE role = 'employee'")["COUNT(*)"];
