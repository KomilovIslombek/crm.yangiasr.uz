...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var DAY_IDS = ['yak', 'dush', 'sesh', 'chor', 'pay', 'jum', 'sha'];
    // Adding
    ...
    */
    ...
    var GregorianCalendarSystem = /** @class */ (function () {
        ...
        GregorianCalendarSystem.prototype.getMarkerMonth = function (d) {
            return  ik_months[d.getUTCMonth()];
        };
        GregorianCalendarSystem.prototype.getMarkerDay = function (d) {
            return d.getUTCDate();
            // return ik_days[d.getUTCDate()];
        };
    ...
    var MINIMAL_RAW_EN_LOCALE = {
        ...
        timeHint: 'Vaqt',
        eventHint: 'Event',
        allDayText: 'barcha-kun',
        moreLinkText: 'Yana',
        noEventsText: 'Ko\'rish uchun hech qanday voqea yo\'q',
    };
    ...
    function organizeRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'uz';
        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    ...
                    var isDisabled = (!props.isTodayEnabled && buttonName === 'bugun') ||
